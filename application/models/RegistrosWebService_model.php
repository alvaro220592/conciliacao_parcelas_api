...
class RegistrosWebService_model extends CI_Model {

    use CrudTrait;
    
    private $tabela = 'registros_webservice';
    private $camposCrud;
    private $data;
    ...
    public function __construct(){
        ...
        $this->camposCrud = $this->data ? ['flg_pago' => $this->data['flg_pago'], 'data_pagto' => $this->data['data_pagto'], 'obs' => $this->data['obs'], 'data_registro' => $this->data['data_registro']] : '';
    }
